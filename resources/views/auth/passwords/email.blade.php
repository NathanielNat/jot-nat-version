...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <p class="text-blue-300 ">Enter your email to reset password</p>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('password.email') }}" class="pt-8">
                ...
                <div class="relative">
                    <label for="email" class="uppercase absolute text-blue-500 text-xs pl-3 pt-2 font-bold "> E-mail</label>
                    ...
                    <div class="pt-8">
                        <button type="submit" class="uppercase rounded w-full bg-gray-400 text-blue-800 py-2 px-3 text-left font-bold">
                            Send Reset Email
                        </button>
                    </div>
