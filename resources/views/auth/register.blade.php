...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="{{ route('register') }}" class="pt-8">
            ...
            <div class="relative pt-3">
                ...
                <div class="col-md-6">
                    <input id="name" type="text"
                        class="pt-8 w-full bg-blue-800 rounded pl-3 text-gray-100 outline-none focus:bg-blue-700"
            ...
            <div class="pt-8">
                <button type="submit"
                    class=" w-full bg-gray-100 uppercase rounded text-blue-800 text-left py-2 px-3 font-bold">
                    Register
                </button>
            </div>
