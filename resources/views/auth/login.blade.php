...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <h2 class="text-blue-300 pb-5">Enter Your Credentials </h2>
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            ...
            <div class="relative pt-3 ">
                ...
                <div class="col-md-6">
                    <input id="password" type="password" class="pt-8 w-full bg-blue-800 rounded p-3 text-gray-100 outline-none focus:bg-blue-700" name="password" required autocomplete="current-password" placeholder="Password">
                    ...
                    <div class="pt-8">
                        <button type="submit" class="uppercase rounded text-blue-800 w-full text-left bg-gray-400 py-2 px-3 font-bold">
                            Login
                         </button>
                    </div>
